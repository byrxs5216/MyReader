...
public class ShowMaxImageView extends ImageView {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (mHeight != 0) {
			...
			if (resultHeight >= AppUtils.getScreenHeight((Activity) getContext())) {
				resultHeight = AppUtils.getScreenHeight((Activity) getContext()) / 3;
			}
