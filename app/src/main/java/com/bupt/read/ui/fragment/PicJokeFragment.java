 ...
 */
public class PicJokeFragment extends BaseFragment implements AnimaJokesListView{
    private XRecyclerView mXRecyclerView;
    private AnimaJokesPresenterImpl jokesPresenter;
    private MyAnimaJokesAdapter animaAdapter;
    private List<AnimationJokeItem> pic_jokes = new ArrayList<AnimationJokeItem>();
    ...
    protected void initView(View rootView, Bundle savedInstanceState) {
        mXRecyclerView = (XRecyclerView) rootView.findViewById(R.id.picjokes_xrecyclerview);
        layoutManager = new LinearLayoutManager(context);
        layoutManager.setOrientation(OrientationHelper.VERTICAL);
        mXRecyclerView.setLayoutManager(layoutManager);
        mXRecyclerView.setHasFixedSize(true);
        animaAdapter = new MyAnimaJokesAdapter(pic_jokes, context);
        ...
        jokesPresenter = new AnimaJokesPresenterImpl(context,"341-2", Constant.APP_ID,Constant.APP_SECRET,1);
    ...
    protected int getLayoutId() {
        return R.layout.fragment_pic_jokes;
    }
