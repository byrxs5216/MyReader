...
/** 
 * DAO for table TABLE_NEWS.
*/
public class TableNewsDao extends AbstractDao<TableNews, Long> {

    public static final String TABLENAME = "TABLE_NEWS";

    /**
     * Properties of entity TableNews.<br/>
    ...
    */
    ...
    public TableNewsDao(DaoConfig config) {
        super(config);
    }
    
    public TableNewsDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'TABLE_NEWS' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'TABLE_NEWS'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, TableNews entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public TableNews readEntity(Cursor cursor, int offset) {
        TableNews entity = new TableNews( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, TableNews entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(TableNews entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(TableNews entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
